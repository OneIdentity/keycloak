...
public class AdminRoles {
    ...
    public static String VIEW_ORGANIZATIONS = "view-organizations";
    ...
    public static String[] ALL_REALM_ROLES = {VIEW_REALM, VIEW_USERS, VIEW_CLIENTS, VIEW_EVENTS, VIEW_IDENTITY_PROVIDERS, VIEW_ORGANIZATIONS, MANAGE_REALM, MANAGE_USERS, MANAGE_CLIENTS, MANAGE_EVENTS, MANAGE_IDENTITY_PROVIDERS, MANAGE_ORGANIZATIONS};
